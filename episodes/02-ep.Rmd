...
**Descriptive Metadata** describes the characteristics of the dataset so for instance authors, abstracts, and any relevant publication. **Structural metadata** describes how it is generated, and how it is internally structured. **Administrative metadata** describes who managed the data, collaborators and project funds.  
...
>>>>>>> 7b0ada98f36f1f0774563a3511a20417f9f10460
:::
...
Usually, when the data is generated, both metadata and data files are separate files. As a researcher, you should ensure that both files refer to each other. Some tools can help you to do so. An example is a FAIRFier tool which helps you.
